...
#define LEDC_DUTY_CHNG_END_LSCH0_INT_RAW (1<<4)
#define LEDC_DUTY_CHNG_END_LSCH0_INT_RAW_M (1<<4)
...
#define LEDC_PARA_UP_LSCH0_M (1<<4)
...
typedef enum {
	LEDC_SLOW_CLK_RC_FAST = LEDC_USE_RC_FAST_CLK,
	LEDC_SLOW_CLK_APB = LEDC_USE_APB_CLK,
	LEDC_SLOW_CLK_XTAL = LEDC_USE_XTAL_CLK,
	LEDC_SLOW_CLK_RTC8M __attribute__((deprecated)) = LEDC_SLOW_CLK_RC_FAST,
} ledc_slow_clk_sel_t;
...
void ledc_ll_get_max_duty(ledc_dev_t *hw, ledc_mode_t speed_mode, ledc_timer_t channel_num, uint32_t *max_duty);
